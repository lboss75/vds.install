...
cd %SourceDir%\build
devenv vds.sln /Build Release /Project vds_windows 

set SourceDirTools=%root_folder%..\..\..\vds.net
cd %SourceDirTools%\src\client\IVySoft.VDS.Client.UI.WPF
dotnet build IVySoft.VDS.Client.UI.WPF.csproj -c Release 

cd %SourceDirTools%\src\client\IVySoft.VDS.Client.UI.WPF.Wallet
dotnet build IVySoft.VDS.Client.UI.WPF.Wallet.csproj -c Release 

cd %SourceDirTools%\src\client\IVySoft.VDS.Client.UI.WPF.Disk
dotnet build IVySoft.VDS.Client.UI.WPF.Disk.csproj -c Release 
